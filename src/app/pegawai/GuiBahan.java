...
try {
 Integer Count;
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 390, 110));

        jLabel3.setText("Cari Data");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, -1, -1));
        jPanel2.add(txtcari, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, 210, 20));
        ...
        jPanel2.add(btncari, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 10, -1, -1));
...
try{
 ...
 if ((txtcari.getText().length()==0)){
        ...
        java.sql.ResultSet sql = stm.executeQuery("select * from bahan Where bahan like '%" +txtcari.getText()+"%'");
        data.setModel(DbUtils.resultSetToTableModel(sql));
